...
% Formatting time_num
time_num = datenum(time_cell_string,'HH:MM:SS');

% Formatting date_string
date_string = datestr(date_cell_string,'MM/DD/YY');

% Removing excess numbers from date_string
day_string = date_string(1:end,4:end-3);

% Converting date_string to num
day_num = str2num(day_string);
